...
/**
 * This class consists of methods that operate on a XML file used as template in
 * order to generate a Schematron model to validate XML messages used inside the
 * SCPS framework and based on the related ontology. This class provides methods
 * to easily actuate a substitution of the words identified inside the template
 * using as strating chars the sequence '$$'.
 * 
...
public class Schema {
	 ...
	 * 
	 * @param fileName
	 *            the name of the file where is the template
	 */
	 ...
	 *
	 * @param file
	 *            the file object containing the template
	 */
	 ...
	 * 
	 * @param replacements
	 *            the map that links template keyword to the replacement text
	 ...
	 * 
	 * @param fileName
	 *            the name of the file where to save the schematron model
	 */
